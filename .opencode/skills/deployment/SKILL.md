...
- The "1% manual" after install (OpenCode.md §12): Nextcloud admin + link Mail app to local IMAP; Jellyfin/Navidrome/ABS/Booklore admin accounts + libraries; Prowlarr indexers; connect *arrs to qBittorrent/SABnzbd/slskd; Seerr<->Jellyfin; Vaultwarden admin; HA onboarding; Beszel agent key.
