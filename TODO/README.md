...
| 05 | [Identity & Access](05-Identity-Access/todo.md) | ~ pass 1 | ZITADEL IdP (replaces Authentik), oauth2-proxy, WG QRs |
...
- [ ] ZITADEL pass 2: rotate admin password, create profile-page OIDC app, invite family users
