...
| **builder** | Grok 4.6 | Executes plans: NixOS modules, service config, multi-file changes. Top agentic (58.7) + near-top coding (76.8) at $2/$6. |
...
Models are a lever: each role has a default, but JOAT picks the model per task. Agents are the contract; models are the cost/quality tradeoff. (Set chosen 2026-08-08 from OpenRouter Artificial-Analysis + Design Arena benchmarks; builder moved to Grok 4.6 on 2026-08-13 — higher agentic index than GPT-5.6 Terra at the same price.)
