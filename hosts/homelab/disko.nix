  ...
  disko.devices = {
    ...
    zpool.rpool = {
      ...
      datasets = {
        ...
        work = { type = "zfs_fs"; mountpoint = "/work"; recordsize = "128K"; };
        fast = { type = "zfs_fs"; mountpoint = "/fast"; recordsize = "128K"; };
        slow = { type = "zfs_fs"; mountpoint = "/slow"; recordsize = "1M"; compression = "zstd"; };
      };
    };
  };
}
